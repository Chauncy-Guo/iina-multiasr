/**
 * audio/extractor.js ¡ª Extract an audio track from a video file via ffmpeg.
 *
 * The output is a 16kHz mono 16-bit PCM WAV ¡ª the format required by
...
export async function extractAudio(sourcePath) {
    ...
    log.info(`Extracting audio via ffmpeg ¡ú ${outPath}`);
